...
| 轨道 | 模块 | 更新对象 | 文件路径 |
|------|------|----------|----------|
| 本体轨道 | `update_manager.rs` | APK 安装包 | `src-tauri/src/vcp_modules/update_manager.rs` |
| 资源轨道 | `frontend_update_manager.rs` | 前端静态资源（HTML/CSS/JS） | `src-tauri/src/vcp_modules/frontend_update_manager.rs` |
...
本节基于 `src-tauri/src/vcp_modules/update_manager.rs`（222 行）。
...
本节基于 `src-tauri/src/vcp_modules/frontend_update_manager.rs`（567 行）。
...
*文档生成基于源码：*
- `src-tauri/src/vcp_modules/update_manager.rs`（222 行）
- `src-tauri/src/vcp_modules/frontend_update_manager.rs`（567 行）
