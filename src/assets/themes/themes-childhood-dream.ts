...
export const variables = {
  ...
  "--user-text": "#FFFFFF",
  "--agent-text": "#dce2f7",
  "--user-bubble-bg": "rgba(196, 114, 55, 0.95)",
  "--assistant-bubble-bg": "rgba(31, 45, 75, 0.96)",
  "--button-bg": "#f58a4b",
  ...
  "--user-text": "#2F4F4F",
  "--agent-text": "#2F4F4F",
  "--user-bubble-bg": "rgba(128, 213, 246, 0.94)",
  "--assistant-bubble-bg": "rgba(254, 215, 235, 0.95)",
  "--button-bg": "#FF69B4",
