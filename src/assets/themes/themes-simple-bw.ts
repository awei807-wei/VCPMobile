...
export const variables = {
  ...
  "--user-text": "#e0e0e0",
  "--agent-text": "#e0e0e0",
  "--user-bubble-bg": "rgba(35, 108, 167, 0.93)",
  ...
  light: {
  "--chat-wallpaper-light": "'light.webp'",
  "--primary-bg": "#f4f6f8",
  "--secondary-bg": "#ffffff",
  "--tertiary-bg": "#e9edf0",
  "--accent-bg": "#e0e6eb",
  ...
  "--user-text": "#2c3e50",
  "--agent-text": "#2c3e50",
  "--user-bubble-bg": "rgba(120, 198, 249, 0.92)",
  "--assistant-bubble-bg": "rgba(232, 244, 248, 0.95)",
  "--button-bg": "#3498db",
