  ...
  <div v-else class="space-y-4">
    <div v-if="assistantStore.groups.length > 0" class="space-y-2">
      ...
      <div ref="groupListRef" class="space-y-2">
        <div
          ...
          :key="group.id"
          class="relative rounded-xl overflow-hidden w-full drag-handle"
        >
          <div
          ...
          >
            ...
            <div class="flex flex-col overflow-hidden flex-1">
              ...
              <span
                class="text-[9px] opacity-40 truncate uppercase tracking-tighter"
                >{{ group.members.length }} Members • {{ group.mode }}</span
              >
            </div>
          </div>
        </div>
    ...
    <div v-if="assistantStore.agents.length > 0" class="space-y-2">
      ...
      <div ref="agentListRef" class="space-y-2">
        ...
        >
          <div
            class="absolute inset-0 bg-black/10 dark:bg-white/10 flex items-center justify-start z-0"
